...
scp -r /d/VS_code/projects/strawberry_grasp/pickup_v2/pi \
       /d/VS_code/projects/strawberry_grasp/pickup_v2/calibration \
       pi:vs_code/strawberry_grasp/pickup_v2/
```

> PowerShell 里 scp 路径写 `D:/VS_code/.../pickup_v2/pi` 也可。
